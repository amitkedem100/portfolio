...
const ADDITIONAL_WORK_ITEMS: AdditionalWorkItem[] = [
  ...
  },
  {
    ...
    mediaType: "image",
    mediaSrcLight: encodeURI("/images/Additional work/Luma cover light.png"),
    mediaSrcDark: encodeURI("/images/Additional work/Luma cover dark.png"),
    thumbnailAlt: "Luma mobile app project cover",
    slides: [
      {
        id: "luma-screens",
        mediaType: "image",
        src: encodeURI("/images/Additional work/Luma screens cb1.png"),
        modalSrc: encodeURI("/images/Additional work/Luma screens full_screen_high_res.png"),
        alt: "Luma mobile app screens overview",
      },
      {
        id: "luma-video",
        mediaType: "video",
        src: encodeURI("/videos/Additional work/Luma video.mp4"),
        alt: "Luma mobile app walkthrough video",
      },
    ],
    tags: [
      "Mobile App",
